...
let datatTableOptions={         
    dom: "Bfrtilp",/*Esto es para los botones, cada letra significa algo, como b:button*/
    buttons:[
    {
    ...
    {
        extend: "print", //para descargar formato excel
        text:"<i class='fa-solid fa-print'></i>", //enlace de font-awesome
        titleAttr:"Imprimir", //mensaje al pasar el mouse
        className:"btn btn-info", //color
    },
],
lengthMenu:[10, 20, 30, 40],
/*columnDefs[
    {orderable: false, target: [3]}, Deshabilitar ordenador de columnas teniendo en cuenta el array esa sería la 4ta columna, se separan por comas
    {searchable: false, target:[3]}, Deshabilitar los campos en los que el buscador busca los datos
    {width: '20%', target: [1]}, Dar ancho a las columnas

],
pageLengt: 5, cantidad de filas que se ven al pirncipio por default, luego se pueden arreglar con el primer cosito
*/
language: {
    "autoFill": {
        "cancel": "Cancelar",
